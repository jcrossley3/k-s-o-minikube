...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner KnativeServing
...
func (r *ReconcileKnativeServing) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set KnativeServing instance as the owner and controller
...
func newPodForCR(cr *servingv1alpha1.KnativeServing) *corev1.Pod {
